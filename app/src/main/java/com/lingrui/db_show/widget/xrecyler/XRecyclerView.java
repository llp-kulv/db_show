...
public class XRecyclerView extends RecyclerView {
    ...
    protected int mRefreshProgressStyle = ProgressStyle.BallClipRotate;
    protected int mLoadingMoreProgressStyle = ProgressStyle.BallClipRotate;
    ...
    protected final AdapterDataObserver mDataObserver = new DataObserver();
    ...
    public XRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            music = sp.load(mContext, R.raw.drip, 1);
        } catch (Exception e) {
            if (sp != null) {
                sp.release();
                sp = null;
...
//        getAdapter().notifyDataSetChanged();
        if (loadingMoreEnabled && mLoadingListener != null) {
            ...
            this.smoothScrollToPosition(mWrapAdapter.getItemCount() + 20);
        }
    }
                ...
                if (isOnTop() && pullRefreshEnabled && appbarState == AppBarStateChangeListener.State.EXPANDED) {
                    if (mRefreshHeader.releaseAction()) {
                        if (mLoadingListener != null) {
                            if (mContext.getResources().getBoolean(R.bool.xrecyclerview_refresh_sound)) {
