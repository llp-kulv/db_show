...
public class DefaultContentAdapter extends ArrayAdapter<List<String>> {
    ...
    public int getCount() {
        ...
        Log.d("DefaultContentAdapter", "getCount: " + count);
        return count;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Log.d("DefaultContentAdapter", "getView contentItemSize:" + contentItemSize
                + " itemData:" + itemData);
        ...
        for (int i = 0; i < contentItemSize; i++) {
            ...
            Log.d("DefaultContentAdapter", "i:" + i + " string:" + itemData.get(i));
        }
