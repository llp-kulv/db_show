package com.lingrui.panellistlibrary;
...
public abstract class AbstractPanelListAdapter {
    ...
    protected boolean isDefaultAdapter = false;
    ...
    protected int itemHeight = 150;// 默认150px 的高度

    protected List<IDBData> contentBeanList;
    ...
    public void setContentBeanList(List<IDBData> beanList) {
        this.contentBeanList = beanList;
    }
    ...
    public void initAdapter() {
        ...
        if (contentAdapter == null) {
            if (isDefaultAdapter) {
                contentAdapter = new DBContentAdapter(context, R.layout.defaultcontentitem, contentBeanList,
                        itemWidthList, itemHeight, lv_content);
            } else {
